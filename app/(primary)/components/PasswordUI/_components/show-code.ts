export const title = "Password UI";
export const routepoint = "password-ui";
export const description =
  "Interactive 3D password strength UI with animated reactive mascot, eye tracking, and live validation.";

export const cliscript =
  "add https://cursorxui.vercel.app/registry/password-ui.json";
...
const packagescript = "framer-motion lucide-react clsx tailwind-merge";
...
export const democode = `import PasswordUI from "@/components/password-ui";

export function PasswordUIExample() {
  return (
...
const MOUTH_PATHS: Record<number | string, string> = {
  0: 'M 44 68 Q 50 63 56 68',
  1: 'M 44 67 Q 50 65 56 67',
  2: 'M 44 67 Q 50 68 56 67',
  3: 'M 43 65 Q 50 71 57 65',
  4: 'M 41 64 Q 50 74 59 64 Z',
  success: 'M 41 65 Q 50 75 59 65 Z',
};
...
> = {
  0: { lY: -2, lR: 18, rY: -2, rR: -18 },
  1: { lY: -1, lR: 10, rY: -1, rR: -10 },
  2: { lY: 0, lR: 0, rY: 0, rR: 0 },
  3: { lY: -3, lR: -3, rY: -3, rR: 3 },
  4: { lY: -5, lR: -5, rY: -5, rR: 5 },
};
