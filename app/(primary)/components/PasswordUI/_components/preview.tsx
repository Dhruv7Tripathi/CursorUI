    ...
    <MainContentContainer>
      ...
      {!sourceCode ? (
        <PreviewComponentContainer>
          <div className="flex min-h-[620px] w-full items-center justify-center rounded-xl border border-zinc-800 bg-[#121316] overflow-hidden p-4 relative">
            <PasswordUI />
          </div>
        </PreviewComponentContainer>
      ) : (
...
export default PasswordUIPreview;

export const LivePreviewPasswordUI = () => {
  return (
