...
export const cliscript = "add https://www.orbitxui.vercel.app/registry/gravitywell.json";
...
export const animatedFormProps = [
  ...
  {
    prop: "mode",
    type: `"normal" | "orbit" | "chaos"`,
    default: `"normal"`,
    description: "Physics simulation mode.",
  },
  {
    prop: "background",
    type: "string",
  ...
  {
    prop: "onWell",
    type: "(x:number,y:number,type:WellType)=>void",
    default: "-",
    description: "Callback fired whenever a gravity well is created.",
  },
];
...
export function GravityWellExample() {
  return (
    <GravityWell
      mode="orbit"
      particleCount={300}
