    ...
    <header className="relative z-10 mx-auto w-full max-w-7xl px-5 pt-5 sm:px-8 sm:pt-7 lg:px-10">
      <nav aria-label="Main navigation" className="flex items-center justify-between">
        ...
        <details className="group relative md:hidden">
          <summary className="flex size-10 cursor-pointer list-none items-center justify-center rounded-lg border border-border bg-white dark:bg-black text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand [&::-webkit-details-marker]:hidden">
            <Menu className="size-4  group-open:hidden" />
            <X className="hidden size-4 group-open:block" />
            <span className="sr-only">Open navigation menu</span>
          </summary>
          <div className="absolute right-0 top-12 flex w-48 flex-col gap-1 rounded-xl border border-border bg-white dark:bg-black p-2 shadow-2xl shadow-background/50">
